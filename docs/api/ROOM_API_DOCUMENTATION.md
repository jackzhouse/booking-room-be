...
## Base URL
```
https://api.prd.teknologikartu.com/booking/api/v1
```
...
**Request:**
```bash
curl -X GET "https://api.prd.teknologikartu.com/booking/api/v1/rooms?active_only=true" \
...
**Request:**
```bash
curl -X GET "https://api.prd.teknologikartu.com/booking/api/v1/rooms/507f1f77bcf86cd799439011" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**Request:**
```bash
curl -X GET "https://api.prd.teknologikartu.com/booking/api/v1/rooms/507f1f77bcf86cd799439011/schedule?start_date=2026-02-20&end_date=2026-02-20" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**Request:**
```bash
curl -X POST "https://api.prd.teknologikartu.com/booking/api/v1/rooms" \
...
**Request:**
```bash
curl -X PATCH "https://api.prd.teknologikartu.com/booking/api/v1/rooms/507f1f77bcf86cd799439011" \
  -H "Authorization: Bearer YOUR_ADMIN_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "Ruang Meeting 1 (Updated)",
...
**Request:**
```bash
curl -X PATCH "https://api.prd.teknologikartu.com/booking/api/v1/rooms/507f1f77bcf86cd799439011/toggle" \
  -H "Authorization: Bearer YOUR_ADMIN_JWT_TOKEN"
```
...
**Request:**
```bash
curl -X DELETE "https://api.prd.teknologikartu.com/booking/api/v1/rooms/507f1f77bcf86cd799439011" \
  -H "Authorization: Bearer YOUR_ADMIN_JWT_TOKEN"
```
...
const getRooms = async () => {
  const response = await fetch(
    'https://api.prd.teknologikartu.com/booking/api/v1/rooms',
    {
      headers: {
...
const updateRoom = async (roomId, roomData) => {
  const response = await fetch(
    `https://api.prd.teknologikartu.com/booking/api/v1/rooms/${roomId}`,
    {
      method: 'PATCH',
      headers: {
        'Authorization': `Bearer ${adminToken}`,
